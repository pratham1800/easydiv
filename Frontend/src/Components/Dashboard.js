          ...
          <li className="outerli">
            ...
            <ol className="innerol">
              {friend.map((f) => {
                ...
                return <li className="innerli">{f.name}</li>;
              })}
            </ol>
          </li>
          <li className="outerli">
            ...
            {user.expenses ? (
              <ul>
                {Object.keys(user.expenses).map((f, i) => {
                  if (user.expenses[f].user._id != user._id && user.expenses[f].amount > 0) {
                    return (
                      <li key={i} className=" flex align-items-center">
                        ...
                        <div className=" flex flex-col">
                          <span className="mx-1 text-black ">{user.expenses[f].user.name}</span>
                          <span className="mx-1" style={{ color: "#FF652F" }}>
                            {" "}
                            you owe{" "}
                            <span style={{ fontWeight: "bold" }}>
                              {`₹${user.expenses[f].amount}`}
                            </span>
                          </span>
                        </div>
                      </li>
                      ...
                      <li key={i} className=" flex align-items-center">
                        ...
                        <div className=" flex flex-col">
                          ...
                          <span className="mx-1" style={{ color: "#1CC29F" }}>
                            ...
                            owes you{" "}
                            <span style={{ fontWeight: "bold" }}>
                              {`₹${Math.abs(user.expenses[f].amount)}`}
                            </span>
                          </span>
                        </div>
                      </li>
